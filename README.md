...
## Installation
#### Clone Repository <br>`git clone https://github.com/ahmet-sakar/json-translate`
#### Build package <br> `npm run build`
#### Run <br> `jsontt <path/file.json>` or `npm run start <path/file.json>`
